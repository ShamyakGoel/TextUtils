...
export default function About() {
  ...
  const toggleStyle = ()=>{
      if(!document.getElementById("flexSwitchCheckDefault1").checked){
...
<div className="form-check form-switch">
  <input onClick={toggleStyle} className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault1" />
